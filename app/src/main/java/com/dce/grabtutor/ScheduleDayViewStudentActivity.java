...
public class ScheduleDayViewStudentActivity extends AppCompatActivity {
...
//    View vRvScheduleDayDivider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schedule_day_view_student);
...
//                    vRvScheduleDayDivider.setVisibility(View.GONE);
    ...
    public class ScheduleAvailableAdapter extends RecyclerView.Adapter<ScheduleAvailableAdapter.ViewHolder> {
        ...
        @Override
        public ScheduleAvailableAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_schedule_day_available, viewGroup, false);
            ScheduleAvailableAdapter.ViewHolder vh = new ScheduleAvailableAdapter.ViewHolder(v);

            return vh;
        }

        @Override
        public void onBindViewHolder(ScheduleAvailableAdapter.ViewHolder holder, final int position) {
            ...
            holder.btnRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URI.SCHEDULE_REMOVE_BOOKED,
    ...
    public class ScheduleReservedAdapter extends RecyclerView.Adapter<ScheduleReservedAdapter.ViewHolder> {
        ...
        @Override
        public ScheduleReservedAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_schedule_day_reserved, viewGroup, false);
            ScheduleReservedAdapter.ViewHolder vh = new ScheduleReservedAdapter.ViewHolder(v);

            return vh;
        }

        @Override
        public void onBindViewHolder(ScheduleReservedAdapter.ViewHolder holder, final int position) {
            final Schedule schedule = this.schedules.get(position);
            String hourStart = String.format("%02d", schedule.getSched_hour());
            String hourEnd = String.format("%02d", schedule.getSched_hour() + 1);
            String minute = String.format("%02d", schedule.getSched_minute());
